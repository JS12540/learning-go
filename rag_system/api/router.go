...
// Reason not to import handler is because in go when you create file under same package, it will automatically be imported and shared accross the same package , in this case the api package
